...
if __name__ == '__main__':
    ...
    agent = ddqn.Agent(env, ddqn.DQNSimple, env.observation_space.shape[0], int(env.action_space.n), 128, device=DEVICE)

    # TODO: train working pixel model
    #agent = ddqn.Agent(env, ddqn.DQNPixel, int(env.action_space.n), 256, device=DEVICE)
    ...
    for i in range(10):
        ...
        save_replay(f'./replays', f'ddqn-{env_name[:-3].lower()}-{i}', replay, 30)
